...
--Sum function--
Select sum(Salary) as [Total_Expenditure] from EmployeeRecords

--avg (average) function--
Select avg(Salary) as [Average] from EmployeeRecords

Select sum(Salary) as [Total_Expenditure],avg(Salary) as [Average_Salary] from EmployeeRecords
...
--Finding Sum of Quantity, sum of totalamount, avg of quantity, avg of total amount for each distinct product
